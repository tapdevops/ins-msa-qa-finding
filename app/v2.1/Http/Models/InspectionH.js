...
const connectInspection = mongoose.createConnection(db.inspection[config.app.env].url, {useNewUrlParser: true});
...
|--------------------------------------------------------------------------
*/
module.exports = connectInspection.model('Inspection H_v_2_1', InspectionHSchema, 'TR_BLOCK_INSPECTION_H');